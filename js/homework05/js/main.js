...
const getUsersByEyeColor = (arr, color) => arr.find(user => user.eyeColor === color);
...
const getUserByEmail = (arr, email) => arr.find(user => user.email);
...
const getTotalBalance = arr => arr.reduce((acc, ball) => acc + ball.balance, 0);
